...
- Discussion
  ...
  - The dataset of “MCI” have **97** observations and **6** variables of
...
- Questions
  ...
  - How many participants were recruited, and of these how many develop
    MCI?
    - **483** participants were recruited and **97** participants develp
      MCI.
...
- Discussion
  ...
  - The important steps in the import process are **using “read_csv” to
    ...
    values**;
  - The dataset of “mci_amyloid” have **2263** observations and **3**
...
- Conclusion
  ...
  - I find that some participants appear in only the baseline or amyloid
    datasets. The amyloid datasets have **4** more participants than the
    baseline datasets. Baseline datasets have participants ids from 1 to
    483, but amyloid datasets have non-consecutive participant ids from
    1 to 495.
...
- Conclusion
  - The “combine_df” dataset have **437** observations and **8**
